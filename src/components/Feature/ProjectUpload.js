...
function ProjectUpload({setLoading}) {
      ...
      <div>
        <div className="max-w-7xl mx-auto mt-6">
          ...
          <div className="flex flex-col justify-center items-center"> 
            ...
            <h4 className='text-hs-orange text-sm sm:text-sm md:text-sm lg:text-xl'>Import Project Construct Connect File to HubSpot</h4>
          </div>
